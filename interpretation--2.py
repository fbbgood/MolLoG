...
state_dict = torch.load(r'D:\a研究\MolLoG\result\best_model_epoch_38.pth', map_location=torch.device('cpu'))
model.load_state_dict(state_dict)

model.eval()

test_data_path = r'D:\a研究\MolLoG\datasets\interpretation-sample.csv'
